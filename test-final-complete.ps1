# test-final-complete.ps1
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "🧪 تست کامل Learning Academy" -ForegroundColor Cyan
...
# ============================================
# 6. تست Admin Exercises
# ============================================
Write-Host "[6] Testing Admin Exercises..." -ForegroundColor Yellow
try {
...
# ============================================
# 7. تست Admin Achievements
# ============================================
Write-Host "[7] Testing Admin Achievements..." -ForegroundColor Yellow
try {
