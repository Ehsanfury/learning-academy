 ...
 * - ✅ FIXED: Proper data unwrapping with fallbacks
...
function AdminAnalyticsPage() {
  ...
  const loadAnalytics = async () => {
    try {
      ...
      // ✅ FIXED: Safe data unwrapping with fallbacks
      const responseData = response?.data?.data || response?.data || {};

      setData({
        totalViews: responseData.totalViews || 0,
        uniqueVisitors: responseData.uniqueVisitors || 0,
        memberVisitors: responseData.memberVisitors || 0,
        guestVisitors: responseData.guestVisitors || 0,
        dailyViews: Array.isArray(responseData.dailyViews)
          ? responseData.dailyViews
          : [],
        topPages: Array.isArray(responseData.topPages)
          ? responseData.topPages
          : [],
        deviceStats: Array.isArray(responseData.deviceStats)
          ? responseData.deviceStats
          : [],
        browserStats: Array.isArray(responseData.browserStats)
          ? responseData.browserStats
          : [],
      });
    } catch (err) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-800">
        ...
        <div className="flex items-end gap-1 h-40">
          {/* ✅ FIXED: Safe check for dailyViews */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-800">
          ...
          {/* ✅ FIXED: Safe check for deviceStats */}
      ...
      <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-800">
        ...
        {/* ✅ FIXED: Safe check for browserStats */}
