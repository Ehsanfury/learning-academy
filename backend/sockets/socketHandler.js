/**
 * socketHandler.js
 * Path: backend/sockets/socketHandler.js
 * Description: WebSocket connection management with JWT authentication
 * Changes:
 * - ✅ FIXED: Added JWT authentication middleware
 * - ✅ FIXED: Room access restricted to authenticated users
 * - ✅ FIXED: Added user validation for all events
...
export const initializeSocket = (io) => {
  // ✅ FIXED: Use authentication middleware
  ...
  io.on("connection", (socket) => {
    ...
    socket.on("submit-answer", (data) => {
      ...
      // ✅ FIXED: Include userId from authenticated socket
    ...
    socket.on("join-ai-tutor", () => {
      // ✅ FIXED: Use authenticated userId
